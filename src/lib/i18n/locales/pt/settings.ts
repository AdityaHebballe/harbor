const settings: Record<string, string> = {
  ...
  "Award tab across the bottom": "Aba de prêmios ao longo da parte inferior",
  ...
  "Show a laurel award tab along the bottom of winning titles, like Netflix. Replaces the corner award chip and sits centered so it clears the rating and watchlist pills.": "Mostrar uma aba de premiação com louros ao longo da parte de baixo dos títulos vencedores, como a Netflix. Substitui o chip de prêmio no canto e fica centralizada para não sobrepor as pílulas de avaliação e de lista para assistir.",
