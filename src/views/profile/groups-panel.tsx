...
export function GroupsPanel({
  ...
  return (
    <section aria-label="Groups" className="mt-6 rounded-[14px] bg-surface p-4 ring-1 ring-edge-soft">
      ...
      {phase === "loading" ? (
        <p className="py-6 text-center text-[13px] text-ink-subtle">Loading groups</p>
      ) : phase === "error" ? (
        <div className="flex flex-col items-center gap-2 py-6">
          <p className="text-[13px] text-ink-subtle">Could not load your groups.</p>
          <button
            onClick={() => load()}
        ...
        <div className="flex max-h-[380px] flex-col gap-0.5 overflow-y-auto [scrollbar-width:thin]">
          {groups.map((g) => (
